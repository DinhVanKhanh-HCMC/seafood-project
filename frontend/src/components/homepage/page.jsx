      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Hải sản tươi sống hôm nay</h2>
            <p className="text-gray-600">Được chọn lọc kỹ càng bởi chuyên gia, giao tận nơi tươi ngon</p>
          </div>
            ...
            {[
              {
                ...
                image: "/fresh-atlantic-salmon-fillet.png",
                rating: 4.8,
                inStock: true,
              },
              {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl p-8 border border-amber-100">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-3xl font-bold text-gray-900 mb-4">Đấu giá hải sản trực tuyến</h2>
                <p className="text-gray-600 mb-6">
                  Tham gia đấu giá trực tuyến và đặt giá cho những sản phẩm hải sản tươi nhất trực tiếp từ thuyền đánh
                  cá. Nhận hải sản cao cấp với giá cạnh tranh.
                </p>
              ...
              <div className="relative">
                <img
                  src="/live-seafood-auction-with-auctioneer-and-fresh-fis.png"
